...
var BookWhere = struct {
	...
	AuthorID: whereHelpernull_String{field: "\"book\".\"author_id\""},
	Name:     whereHelperstring{field: "\"book\".\"name\""},
	Value:    whereHelperint{field: "\"book\".\"value\""},
}
...
var (
	bookAllColumns            = []string{"id", "author_id", "name", "value"}
	bookColumnsWithoutDefault = []string{"id", "author_id", "name", "value"}
